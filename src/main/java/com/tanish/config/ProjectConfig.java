...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages="com.tanish")
public class ProjectConfig {
	...
	public LocalSessionFactoryBean sessionFactory(){
		...
		sessionFactory.setPackagesToScan("com.tanish");
	...
	public ComboPooledDataSource myDataSource(){
		...
		ob.setJdbcUrl("jdbc:mysql://localhost:3306/worldpay");
		ob.setUser("root");
		ob.setPassword("");
